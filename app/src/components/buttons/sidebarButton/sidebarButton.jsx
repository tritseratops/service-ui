...
export const SidebarButtonBase = ({ onClick, icon, children, link, bottom }) => {
  const classes = cx({
    ...
    if (typeof to === 'object') {
      ...
      try {
        ...
        if (process.env.NODE_ENV === 'development') {
          console.warn(
            '[redux-first-router-link]couldnotcreatepathfromaction:',
            action,
            'Forreference,hereareyourcurrentroutes:',
            routesMap,
          );
        }
        return '#';
